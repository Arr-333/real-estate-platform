...
export default function page() {
  ...
  const columns = [
    { field: "stateId", headerName: "ID", width: 150 },
    {
      field: "stateName",
      headerName: "Name",
      width: 250,
    ...
    },
    {
      ...
      sortable: false,
      renderCell: ({ row }) => (
        <Link href={`/admin/state/edit/${row.stateId}`}>
    ...
    },
    {
      ...
      sortable: false,
      renderCell: ({ row }) => (
        <button className="btn" onClick={() => deleteItem(row.stateId)}>
        ...
        <div className="row">
          ...
          <div className="col-lg-9 col-md-9 ">
            <h5 className="text-dark  rad text-center mt-2  p-2">
              State
              <Link href="/admin/state/addstate">
